      ...
      <div className="flex flex-col justify-between flex-grow">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" onClick={()=>handleDecrementQuantity(product._id)} className="size-8 rounded-sm">
              <Minus />
            </Button>
            <p className="font-semibold text-xl p-2">
              {product?.orderQuantity}
            </p>
            <Button variant="outline" onClick={()=>handleIncrementQuantity(product._id)} className="size-8 rounded-sm">
              <Plus />
            </Button>
            <Button variant="outline" onClick={()=>handleRemoveProduct(product._id)}className="size-8 rounded-sm">
