...
export default function UpdateProductForm({product}:{product:IProduct}) {
  ...
  useEffect(() => { 
    //ekhane server action funciton server e kaj kre client e na tai useEffect diya call krte hbe
    ...
    fetchData();//ekhane call kra hyse jate jotobar page render hbe useEffect auto render hbe tkn ae function call hoi data fetch krbe
  }, []);
